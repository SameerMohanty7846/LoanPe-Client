...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@radix-ui/react-dropdown-menu'; // shadcn dropdown components
    ...
    <header className="bg-white shadow-sm z-50 fixed top-0 left-0 right-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex flex-shrink-0 items-center">
            <Link to="/">
              <img src={logo} alt="LoanPe Logo" className="h-12 w-auto sm:h-14 md:h-16" style={{ objectFit: 'contain' }} />
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="h-8 w-8 rounded-full bg-gradient-to-r from-purple-500 to-blue-400 flex items-center justify-center text-white font-medium shadow-md hover:shadow-lg transition-shadow focus:outline-none"
                >
                  JD
                </button>
              </DropdownMenuTrigger>
